...
func (ps productService) GetCustomerProducts(ctx context.Context, req request.GetCustomerProducts) (*[]response.GetProducts, error) {
	products, err := ps.productRepo.GetCustomerProducts(ctx, req)
